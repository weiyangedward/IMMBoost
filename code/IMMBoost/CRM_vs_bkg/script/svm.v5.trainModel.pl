...
# paths to IMM, need to change this to a relative path and check if the code is compiled
my $train = "/home/weiyang4/software/SCRMshaw/bin/imm_build";
my $pred = "/home/weiyang4/software/SCRMshaw/bin/imm_score";
my $auc = "$Bin/auc.R";

# data
my $crmFa = "$crmDir/fasta/crms.newID.fasta"; # CRM seq
my $negFa = "$crmDir/fasta/neg.acc.lenGC.100.fasta"; # background seq
my $msCRM = "$crmDir/fasta/msCRM.fa"; # msCRM seq
